...
const Banner = () => {
    return (
        <div>
             <section className="bg-gray-800 dark:bg-gray-100 text-gray-100 dark:text-gray-800 rounded-xl lg:px-20 w-full">
                <div className="container flex flex-col-reverse justify-center p-2 mx-auto lg:py-24 lg:flex-row lg:justify-around">
                    <div className="flex flex-col justify-center p-2 text-center rounded-sm lg:text-left">
                        <h1 className="my-4 text-2xl lg:text-6xl font-bold leading-10">Books to freshen <br /> up your bookshelf
                        </h1>
