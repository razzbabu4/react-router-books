...
const ListedBooks = () => {
    ...
    return (
        <div className="px-4 lg:px-24 lg:my-8 text-center">
            ...
            <div className="flex float-left mx-4 overflow-x-auto overflow-y-hidden flex-nowrap text-gray-100 w-full flex-grow">
